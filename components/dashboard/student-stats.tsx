...
import { StudentSchemaT, StudentStatsSchemaT } from "@/lib/schemas"
...
export default function StudentStatistics({ className, data }: { className?: string, data: StudentStatsSchemaT }) {
